...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string> ServerId =
        CVarDef.Create("server.id", "OmuStation", CVar.REPLICATED | CVar.SERVER); // if ur a fork of goob pls change this thanks :)

    /// <summary>
    ///     Guide Entry Prototype ID to be displayed as the server rules.
    /// </summary>
    public static readonly CVarDef<string> RulesFile =
        CVarDef.Create("server.rules_file", "OmuRuleset", CVar.REPLICATED | CVar.SERVER);
