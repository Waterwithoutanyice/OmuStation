...
internal sealed class AdminNameOverlay : Overlay
{
    ...
    private static readonly FrozenSet<ProtoId<RoleTypePrototype>> Filter =
        new ProtoId<RoleTypePrototype>[] {"SoloAntagonist", "TeamAntagonist", "SiliconAntagonist", "FreeAgent", "SentientAnimal", "NanoTrasen"} // Goobstation - Sentient Animals adds SentientAnimal, Omu - add NanoTrasen
        .ToFrozenSet();
